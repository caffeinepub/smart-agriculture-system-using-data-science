...
import type { ExternalBlob as _ExternalBlob, PlantDiseaseResult as _PlantDiseaseResult, Time as _Time, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async detectDisease(arg0: ExternalBlob): Promise<PlantDiseaseResult> {
        if (this.processError) {
            try {
                const result = await this.actor.detectDisease(await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg0));
                return from_candid_PlantDiseaseResult_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getCropYieldHistory(): Promise<Array<CropYieldResult>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCropYieldHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getIrrigationHistory(): Promise<Array<IrrigationResult>> {
        if (this.processError) {
            try {
                const result = await this.actor.getIrrigationHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getIrrigationRecommendation(arg0: IrrigationInput): Promise<IrrigationResult> {
        if (this.processError) {
            try {
    ...
    async getPlantDiseaseHistory(): Promise<Array<PlantDiseaseResult>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPlantDiseaseHistory();
    ...
    async predictYield(arg0: CropYieldInput): Promise<CropYieldResult> {
        if (this.processError) {
            try {
                const result = await this.actor.predictYield(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PlantDiseaseResult_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PlantDiseaseResult): Promise<PlantDiseaseResult> {
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        suggestedTreatment: value.suggestedTreatment,
        leafImage: await from_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value.leafImage),
...
async function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PlantDiseaseResult>): Promise<Array<PlantDiseaseResult>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PlantDiseaseResult_n11(_uploadFile, _downloadFile, x)));
}
